...
var icon              = remote.nativeImage.createFromPath(app.getAppPath() + '/soundcloudapp.png');
...
var MediaPlayer = React.createClass({
  ...
  logout: function() {
    window.location.href = 'soundcloudapp://logout'
  },
  ...
  render: function() {
    ...
    var classes = classNames({
      'soundcloudapp__media-player' : true
    })
