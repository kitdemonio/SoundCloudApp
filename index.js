...
mb.on('reset "NODE_ENV=development" & electron .ady', function() {
  ...
  function doLogin() {
    ...
    loginWindow.loadURL('https://soundcloud.com/connect?client_id=f17c1d67b83c86194fad2b1948061c9e&response_type=token&scope=non-expiring&display=next&redirect_uri=soundcloudapp://oauth/callback')
  }
  ...
  /**
   * register soundcloudapp protocol
   */
  var protocol = require('protocol')
  protocol.registerHttpProtocol('soundcloudapp', function(req) {
